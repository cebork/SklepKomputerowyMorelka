...
<html> 
    ...
    <body>
        ...
        <article id="articlee" class="article container">
            <div class="row">
                <h1 class="display-4 d-flex justify-content-center">Historia zamówień</h1>
                <div class="col-2 ">
                </div> 
                <div class="col-8 ">
                    <table class="table table-striped">
                        ...
                        <tbody>
                            <?php
                            $query_zamowienia = "SELECT * FROM statusy s, zamowienia z, users u WHERE s.status_id = z.status_id AND z.user_id = u.user_id AND u.login = '{$_SESSION["login"]}' AND status != 'koszyk'";
                            ...
                            if($result_zamowienia->num_rows > 0){
                                while($row_zamowienia = $result_zamowienia->fetch_assoc()){
                                    echo "<tr class='clickable' data-href='../content/zawartoscZam.php?zam_id={$row_zamowienia["zamowienia_id"]}'>";
