    ...
    <header class="header container-fluid position-fixed bg-primary">
        ...
        <article id="articlee" class="article container">
            <div class="row">
                <div class="col-4"></div>
                <div class="col-4">
                    <h1 class="display-4 d-flex justify-content-center">Raporty</h1>
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <label for="data_start">Data początkowa:</label>
                            <input onchange="raporty()" style="width: 150px;" id="date_start" type="date" class="form-control" id="data_start" aria-describedby="date_start">
                        </div>
                        <div class="input-group-prepend">
                            <label for="data_end">Data końcowa:</label>
                            <input onchange="raporty()" style="width: 150px;" id="date_end" type="date" class="form-control" id="data_end" aria-describedby="date_end">
                        </div>
                    </div>
                    <label for="raport">Wybierz raport:</label>
                    <select onchange="raporty()" id="raport" class="choose form-select" aria-label="Default select example" id="raport">
                        <option value="0">Wybierz raport</option>
                        <option value="6">Sprzedaż dzienna - zamówienia</option>
                        <option value="1">Sprzedaż miesięczna - zamówienia</option>
                        <option value="5">Sprzedaż roczna - zamówienia</option>

                        <option value="9">Sprzedaż dzienna - produkty</option>
                        <option value="10">Sprzedaż miesięczna - produkty</option>
                        <option value="11">Sprzedaż roczna - produkty</option>

                        <option value="2">Zarobki pracowników</option>
                        <option value="3">Ilość założonych kont w danym okresie</option>
                        <option value="4">Popularność produktów</option>
                        <option value="7">Popularność sposobów płatności</option>
                        <option value="8">Popularność dostawców</option>
                    </select>
                </div>  
                <div class="col-4"></div>  
            </div>
            <div class="row" id="raporty">
            </div>
        </article>
