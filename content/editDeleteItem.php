...
<html> 
    ...
    <body>
        ...
        <article id="articlee" class="article container">
            <div class="row">
                <h2 class='display-5 d-flex justify-content-center'>Edycja i usuwanie przedmiotów</h2>
                <div class='d-flex justify-content-center'>
                    <label for="login">Wyszukiwanie: </label>
                    <input type="text" class="form-control" style="width: 200px;" id="fraza" aria-describedby="search" onkeyup="searchItems()">   
                </div>
            </div>
            </br>
            <div class="row">
